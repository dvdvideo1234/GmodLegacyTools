// adding materials to the material tool guns list
...
// Making sure there's no double materials in said list

timer.Simple(0, function()
	local mats, clnr = list.GetForEdit("OverrideMaterials"), {};
	for key, mat in pairs(mats) do
		clnr[mat], mats[key] = true, nil end
	local i = 1;
	for mat in pairs(clnr) do
		mats[i] = mat; i = i + 1; end
	table.sort(mats);
end);
